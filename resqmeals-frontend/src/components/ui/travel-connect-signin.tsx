...
import { Eye, EyeOff, ArrowRight, Trophy, Bot, Clock, Plus, TrendingUp, Package, MapPin, UserCog, Mail, Phone, BellRing, User } from "lucide-react";
...
const DotMap = () => {
  ...
  useEffect(() => {
    ...
    // Drawing helper wrapping context access
    const safeDraw = (fn: (ctx: CanvasRenderingContext2D) => void) => {
      const currentCtx = canvas.getContext("2d");
      if (currentCtx) fn(currentCtx);
    };
